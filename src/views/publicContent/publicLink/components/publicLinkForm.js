...
function PublicLinkForm(props) {
    ...
    const setUpdateData = async (publicLinkData) => {
        ...
        setFormData({
            ...
            instruction: publicLinkData?.instruction
                ...
                : [""],
            active:
                publicLinkData?.active !== undefined
                    ? publicLinkData?.active
                    : true,
        });
    };
    useEffect(() => {
    ...
    const formValidation = () => {
        try {
            publicLinkValidationSchema.validateSync(formData, {
                abortEarly: false,
            });
            return {
                quizId: "",
            ...
            if (Object.keys(errorObject)?.length === 0) {
                ...
                return {
                    ...
                    startDate: errorObject.startDate
                        ...
                        : "",
                    instruction: errorObject.instruction
                        ? errorObject.instruction
                        : [""],
    ...
    const SubmitHandle = async () => {
        ...
        if (!errorObject.status) {
            ...
            if (publicLinkData?._id) {
                const newFormData = {
                    ...formData,
                    password: await useEncryption.encryptData(
                        formData.password
                    ),
                };
            ...
            >
              ...
              /> */}
                            ...
                            <DateTimePicker
                                ...
                                className={
                                    errorData.startDate && "select-error"
                                }
                                viewRenderers={{
                                ...
                                )} // formData?.startDate convert to dayjs.Dayjs
                            />
                        </div>
                    ...
                    <div className="col-span-1 gap-4 mb-4">
                        ...
                        <div className="col-span-2">
                            {formData?.instruction?.map(
                                (instruction, index) => (
                                    <div
                                        className="flex gap-2 md:gap-4 col-span-2 mt-2"
                                        key={index}
                                    >
                                        <Input

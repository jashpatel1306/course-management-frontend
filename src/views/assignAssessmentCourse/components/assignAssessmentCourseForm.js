...
function AssignCourseForm(props) {
    ...
    const getAssessmentOptionData = async (collegeId = "") => {
        ...
        try {
            ...
            if (response.success) {
                setAssessmentsList(
                    response.data.filter((e) => e.value !== "all")
                );
            } else {
                openNotification("danger", response.error);
            }
        ...
        try {
            ...
            if (Object.keys(errorObject)?.length === 0) {
                ...
                return {
                    ...
                    collegeId: errorObject.collegeId
                        ? errorObject.collegeId
                        : "",
                    batchId: errorObject.batchId ? errorObject.batchId : "",
                    sectionId: errorObject?.sectionId
                        ? errorObject?.sectionId
                        : "",
                    lectureId: errorObject?.lectureId
                        ? errorObject?.lectureId
                        : "",
                    ...
                    positionType: errorObject?.positionType
                        ...
                        : "",
                    startDate: errorObject?.startDate
        ...
        <>
                        ...
                        <div className="col-span-2">
                            <Select
                                ...
                                value={assessmentList?.find(
                                    (info) =>
                                        info.value === formData?.assessmentId
                                )}
                                options={assessmentList}
                                className={
                                    errorData.assessmentId && "select-error"
                                }
                            />
                        </div>
                            ...
                            <div className="col-span-1 gap-4 mb-4">
                                ...
                                <div className="col-span-2">
                                    <Select
                                        ...
                                        options={coursesList}
                                        className={
                                            errorData.courseId && "select-error"
                                        }
                                    />
                                </div>
                                {DisplayError(errorData.courseId)}
            ...
            /> */}
                        <DateTimePicker
                            ...
                            value={dayjs(formData?.startDate || new Date())} // formData?.startDate convert to dayjs.Dayjs
                        />
                    </div>
            ...
            /> */}
                        <DateTimePicker
                            ...
                            format="DD-MMM-YYYY HH:mm a"
                            value={dayjs(formData?.endDate || new Date())} // formData?.startDate convert to dayjs.Dayjs

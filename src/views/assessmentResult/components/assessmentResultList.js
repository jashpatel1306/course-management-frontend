...
const AssessmentResult = (props) => {
    ...
    const onHandleDeleteBox = async () => {
        try {
            ...
            console.error("onHandleDeleteBox error:", error);
            openNotification("danger", error.message);
            setDeleteIsOpen(false);
        }
    };
                ...
                <div className="w-full lg:w-auto flex flex-col md:flex-row lg:items-center gap-x-4 ">
                    ...
                    <Select
                        ...
                        value={
                            currentBatchTab
                                ? batchList.find(
                                      (item) => item?.value === currentBatchTab
                                  )
                                : null
                        }
                        onChange={(item) => {
                    ...
                    <Select
                        ...
                        value={
                            currentAssessmentTab
                                ? assessmentList.find(
                                      (item) =>
                                          item?.value === currentAssessmentTab
                                  )
                                : null
                        }
                        onChange={(item) => {
                            setCurrentAssessmentTab(
                                item?.value ? item?.value : ""
                            );

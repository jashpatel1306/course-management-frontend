...
const Intro = ({ onGetStartedClick, exerciseData }) => {
          ...
          <div>
            <div className="gap-y-4">
              ...
              >
                ...
                <span aria-hidden="true">{exerciseData?.title}</span>
              </h1>
              <div className="mt-8">
                <div className="flex gap-8 ">
                  ...
                  <div>
                    ...
                    <span className="block text-gray-800 text-xl">
                      {exerciseData?.totalQuestions} Exercise Questions
                    </span>
                  </div>
                </div>
              </div>
            ...
            <div className="flex flex-col gap-y-8 mb-8">
              ...
              <div className="text-gray-700">
                <ol className="flex flex-col  list-decimal list-inside gap-y-2 text-base pl-[30px]">
                  {exerciseData?.instruction?.map((instruction, index) => {
                    return (
                      <li key={`${exerciseData?._id}-${index}`}>
                        {instruction}
                      </li>
                    );
                  })}

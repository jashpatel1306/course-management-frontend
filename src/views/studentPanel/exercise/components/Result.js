...
export const Result = (props) => {
  // const { results, totalQuestions, exerciseData } = props;
  // const { results, exerciseData } = props;
  // const { correctAnswers, wrongAnswers, secondsUsed } = results;
  // const TIME_LIMIT = exerciseData.totalTime * 60; // 1 minute per question
  ...
  return (
    ...
    >
      {/* <div className="flex flex-col text-black font-bold  text-center w-full">
        <h1 className="font-bold text-2xl text-white">{exerciseData.title}</h1>
      ...
      >
        ...
        <h3 className="text-brand-midnight text-[32px] font-medium leading-9 mt-4 text-gray-700 ">
          {/* Your <span className="font-bold">{exerciseData.title}</span> is submitted. */}

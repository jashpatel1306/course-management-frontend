...
const columns = ["Roll No", "Exircise Name", "total Marks	", "accuracy", "View"];
                ...
                {resultData?.map((item, key) => {
                  return (
                    <Tr key={item?._id} className="capitalize">
                      ...
                      <Td>{`${item?.totalAssignMarks} / ${item?.totalMarks}`}</Td>
                      <Td>{`${(
                        (Number(
                          item?.totalAssignMarks ? item?.totalAssignMarks : 0
                        ) /
                        ...
                        <div className="flex ">
                          <Button
                            ...
                            onClick={() => {
                              ...
                              }app/student/exercise-result/${item?.trackingId}`;

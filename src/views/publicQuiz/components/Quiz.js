    ...
    const fetchQuestionData = async (questionId) => {
        ...
        try {
            ...
            if (response.success) {
                ...
                if (
                    findStatus &&
                    findStatus?.questionId &&
                    findStatus?.fillAnswer
                ) {
            ...
            <>
                <div className="w-full ">
                    ...
                    <div className="flex flex-col md:flex-row">
                        <div className="md:max-w-[260px] md:h-[calc(100vh_-_160px)] lg:max-h-[80vh] md:overflow-y-scroll hidden-scroll p-4 md:p-8 md:pb-0 border-r border-gray-500">
                                        ...
                                        <>
                                            ...
                                            <div className=" pt-2 pb-8">
                                                <div className="mt-2 rounded-xl border-2 border-gray-600 px-5 md:px-7 py-4 w-full mb-8 overflow-auto">
                                                    <h4 className="text-gray-700 font-semibold text-base md:text-lg select-none">
                                                        <span
                                                            dangerouslySetInnerHTML={{
